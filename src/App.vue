  ...
  <div id="app">
    <div class="header">
      ...
      <nav>
        ...
        <button v-on:click="getActual" v-if="is_auth" > ACTUAL <img src="./assets/actual.png"></button>
...
export default {
  ...
  methods: {
    ...
    getActual: function(){
      if(this.$route.name != "user_resumen"){
        let username = localStorage.getItem("current_username")
        this.$router.push({name: "user_resumen", params:{ username: username }})
      }
    },
    getMovi: function(){
